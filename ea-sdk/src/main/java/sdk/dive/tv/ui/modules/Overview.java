...
import sdk.dive.tv.ui.modules.viewholders.OverviewHolder;
...
public class Overview  extends TextModule {
    ...
    public RecyclerView.ViewHolder getViewHolder(LayoutInflater inflater, ViewGroup group) {
        ...
        OverviewHolder holder= new OverviewHolder(viewGroup, getClass().getSimpleName());
        return holder;
    }

    @Override
    public boolean validate(Card cardData, boolean isCarousel) {
        CardContainer container= getContainer(cardData, OVERVIEW.getValue());
        if(container==null){
            return false;
        }
